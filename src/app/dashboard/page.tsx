...
import { JOURNEY_TILES, Icon } from "@/components/dashboard/nav-config";
        ...
        <div className="db-tiles">
          {JOURNEY_TILES.map((t) => (
            <Link
              ...
              className="db-tile"
              data-id={t.id}
              style={t.image ? { backgroundImage: `linear-gradient(180deg, rgba(28,19,12,.12), rgba(28,19,12,.86)), url(${t.image})` } : undefined}
            >
