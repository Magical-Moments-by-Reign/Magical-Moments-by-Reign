...
// ── Curated Collections ──────────────────────────────────────────
// Each collection keeps its existing service route. Photos are cropped from
// the Owner's uploaded marketing artwork (public/luxury/collections/*) where
// provided; Travel, Transportation, and Cruises still use the app's existing
// lifestyle photography since no new artwork was uploaded for those yet.
