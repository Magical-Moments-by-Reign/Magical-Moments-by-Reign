...
export default function OfflinePage() {
  return (
    <main style={{ minHeight: "70vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "2rem", fontFamily: "var(--font-body)", color: "var(--ink, #3f3424)" }}>
      <h1 style={{ fontFamily: "var(--font-display)", fontSize: "2rem", marginBottom: "0.5rem" }}>You&apos;re offline</h1>
      <p style={{ color: "var(--muted, #8a7a63)", maxWidth: "32rem", lineHeight: 1.6 }}>
