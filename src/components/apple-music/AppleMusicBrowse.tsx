      ...
      <div className="amk-hero">
        ...
        <div className="amk-hero__body">
          ...
          <div className="amk-hero__actions">
            ...
            <a className="amk-hero__learn" href="#amk-top-songs">Explore <span aria-hidden="true">→</span></a>
          </div>
        </div>
      </div>

      <div className="amk-pills" role="group" aria-label="Browse Apple Music">
        <a href="#amk-top-songs" aria-current="true">All</a>
        <a href="#amk-top-songs">Top Songs</a>
        {albums.length > 0 && <a href="#amk-new-releases">New Releases</a>}
        {playlists.length > 0 && <a href="#amk-playlists">Playlists</a>}
        <select
          value={genre}
