...
export async function getNearYouEvents(params: { location: string; coords?: { lat: number; lng: number }; keyword?: string; category?: EventCategory; radiusMiles?: number }): Promise<DiscoveryResult<DiscoveredEvent>> {
