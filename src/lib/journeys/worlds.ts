...
const RELATIONSHIP: JourneyWorld = {
  ...
  areas: [
    ...
    { slug: "bachelor-bachelorette", label: "Bachelor or Bachelorette", tagline: "One last adventure.", status: "explore" },
...
const HOME: JourneyWorld = {
  ...
  areas: [
    ...
    { slug: "apartment-rental", label: "Apartment Rental", tagline: "Find the right apartment to call home.", status: "explore",
    ...
    { slug: "vacation-homes", label: "Vacation Homes", tagline: "Your escape. Your place.", image: "/story/vacation.jpg", status: "explore" },
    { slug: "renovation", label: "Renovation", tagline: "Reimagine the home you already love.", status: "explore" },
    { slug: "investment-property", label: "Investment Property", tagline: "Build wealth. Create freedom.", status: "explore" },
