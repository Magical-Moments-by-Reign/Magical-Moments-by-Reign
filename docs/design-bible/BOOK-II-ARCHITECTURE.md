...
| **Journey Preview™** (5-day premium trial) | **Built** (choice + transparent terms/checkout screen: picker, price, dates, limits, reminders) · real start needs auth + payment capture + billing scheduler — see [standard](./STANDARD-journey-preview.md) |
