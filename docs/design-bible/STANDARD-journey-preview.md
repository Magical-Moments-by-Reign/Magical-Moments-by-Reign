# Master Design Bible — Magical Journey Preview™ (5-day premium trial)
...
`/journeys/[type]`). **Magical Journey Preview™** is a **hands-on 5-day trial** of a
...
(Continue with Free Forever · Start a Magical Journey Preview · Purchase immediately) and
the fully transparent **Magical Journey Preview terms/checkout screen** at
...
2. **Start a Magical Journey Preview™** (this feature).
...
One active Magical Journey Preview at a time · one per Journey type · repeat previews on
the same account or payment method are prevented. *(Enforcement needs
auth + payment fingerprinting — later phase.)*

## Reminders

Day 1 "Welcome! Your Magical Journey Preview has officially begun." · Day 3 "You're
...
- **Phase A (done):** three-option choice + transparent Magical Journey Preview terms/
